...
[source,bash,subs="+macros,+attributes"]
----
{kubernetes-cli} get deployments -n %USER%-{tutorial-namespace}
----
...
----
Updating Service 'greeter' in namespace '%USER%-{tutorial-namespace}':
...
[source,bash,subs="+macros,+attributes"]
----
kn service -n %USER%-{tutorial-namespace} delete greeter
----
--
{kubernetes-cli}::
+
...
[source,bash,subs="+macros,+attributes"]
----
{kubernetes-cli} -n %USER%-{tutorial-namespace} delete services.serving.knative.dev greeter
----
--
====
