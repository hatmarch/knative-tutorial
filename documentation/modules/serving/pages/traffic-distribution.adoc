...
----
kn revision ls --namespace %USER%-{tutorial-namespace}
----
...
[source,bash,subs="+macros,+attributes"]
----
{kubernetes-cli} -n %USER%-{tutorial-namespace} get ksvc greeter -oyaml \
...
[source,bash,subs="+macros,attributes"]
----
- http://latest-greeter.%USER%-{tutorial-namespace}.example.com #<1>
- http://v1-greeter.%USER%-{tutorial-namespace}.example.com #<2>
- http://v2-greeter.%USER%-{tutorial-namespace}.example.com #<3>
----
...
[source,bash,subs="+macros,+attributes"]
----
kn -n %USER%-{tutorial-namespace}  service delete greeter
----
