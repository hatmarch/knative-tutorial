...
[NOTE]
====
You can use `stern camel-k` to monitor the progress of the builder pod as well as `watch {kubernetes-cli} kamel get` and monitor the *PHASE* column.  In addition, `watch {kubernetes-cli} get ksvc` looking at the *READY* column to become True.
====
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
{kubernetes-cli} api-resources --api-group=camel.apache.org
----
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
watch kamel -n %USER%-{tutorial-namespace} get
----
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
kn -n %USER%-{tutorial-namespace} service describe echoer
----
...
Age:        5m
URL:        http://echoer.%USER%-{tutorial-namespace}.example.com

Revisions:
  100%  @latest (echoer-g6g68) [1] (5m)
        Image:  10.105.219.172/%USER%-{tutorial-namespace}/camel-k-kit-buifr3v968fjg6sum6e0@sha256:06588f7dfb53e0e6027c975e206c8bb67a03311a90ed2ccafdc883e16c627f25 (at 06588f)
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
{kubernetes-cli} -n %USER%-{tutorial-namespace} get ksvc echoer
----
...
echoer   http://echoer.%USER%-{tutorial-namespace}.example.com   echoer-g6g68    echoer-g6g68   True
----
--
====
