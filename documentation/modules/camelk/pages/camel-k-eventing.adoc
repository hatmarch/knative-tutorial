...
[source,bash,subs="+quotes,+attributes,+macros"]
----
watch kubectl get -n %USER%-{tutorial-namespace} pods
----
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
kubectl apply -n %USER%-{tutorial-namespace} -f get-started/timed-greeter-source.yaml
----
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
watch kubectl -n %USER%-{tutorial-namespace} get camelsources
----
...
kubectl -n %USER%-{tutorial-namespace} delete camelsource timed-greeter
----
