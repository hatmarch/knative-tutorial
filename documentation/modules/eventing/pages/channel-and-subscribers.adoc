...
----
kn channel list -n %USER%-{tutorial-namespace}
----
--
{kubernetes-cli}::
+
...
[source,bash,subs="+macros,+attributes"]
----
{kubernetes-cli} -n %USER%-{tutorial-namespace} get \
...
[source,bash,subs="+macros,+attributes"]
----
kn source ping -n %USER%-{tutorial-namespace} list
----
...
[source,bash,subs="+macros,+attributes"]
----
{kubernetes-cli} -n %USER%-{tutorial-namespace} get pingsource.sources.knative.dev 
----
...
[source,bash,subs="+macros,+attributes"]
----
kn subscription -n %USER%-{tutorial-namespace} list
----
...
[source,bash,subs="+macros,+attributes"]
----
{kubernetes-cli} -n %USER%-{tutorial-namespace} \
...
If you wait approximately 2 minutes for the PingSource then you will see both `eventinghelloa` and `eventinghellob` begin to run in the %USER%-{tutorial-namespace}.
...
.Watch pods in the %USER%-{tutorial-namespace}
[.console-output]
[source,bash]
----
...
[source,bash,subs="+macros,+attributes"]
----
kn service delete -n %USER%-{tutorial-namespace} eventinghelloa
kn subscription delete eventinghelloa-sub --namespace %USER%-{tutorial-namespace}
kn service delete -n %USER%-{tutorial-namespace}  eventinghellob
kn subscription delete eventinghellob-sub --namespace %USER%-{tutorial-namespace}
kn source ping delete -n %USER%-{tutorial-namespace} event-greeter-ping-source
kn channel delete -n %USER%-{tutorial-namespace} eventinghello-ch
----
--
{kubernetes-cli}::
+
...
[source,bash,subs="+macros,+attributes"]
----
{kubernetes-cli} -n %USER%-{tutorial-namespace} delete -f eventing-helloa-sink.yaml
{kubernetes-cli} -n %USER%-{tutorial-namespace} delete -f eventing-helloa-sub.yaml
{kubernetes-cli} -n %USER%-{tutorial-namespace} delete -f eventing-hellob-sink.yaml
{kubernetes-cli} -n %USER%-{tutorial-namespace} delete -f eventing-hellob-sub.yaml
{kubernetes-cli} -n %USER%-{tutorial-namespace} delete -f event-source.yaml
{kubernetes-cli} -n %USER%-{tutorial-namespace} delete -f channel.yaml
----
--
====
