...
[source,bash,subs="+macros,+attributes"]
----
kubectl -n %USER%-{tutorial-namespace} get \
...
[source,bash,subs="+macros,+attributes"]
----
kubectl -n %USER%-{tutorial-namespace} get pingsource.sources.knative.dev 
----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl -n %USER%-{tutorial-namespace} \
...
[source,bash,subs="+macros,+attributes"]
----
kubectl -n %USER%-{tutorial-namespace} delete -f eventing-helloa-sink.yaml
kubectl -n %USER%-{tutorial-namespace} delete -f eventing-helloa-sub.yaml
kubectl -n %USER%-{tutorial-namespace} delete -f eventing-hellob-sink.yaml
kubectl -n %USER%-{tutorial-namespace} delete -f eventing-hellob-sub.yaml
kubectl -n %USER%-{tutorial-namespace} delete -f event-source.yaml
kubectl -n %USER%-{tutorial-namespace} delete -f channel.yaml
----
--
====
