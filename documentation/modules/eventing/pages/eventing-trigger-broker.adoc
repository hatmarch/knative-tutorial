...
[source,bash,subs="+macros,+attributes"]
-----
kubectl -n %USER%-{tutorial-namespace} apply -f curler.yaml
-----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl -n %USER%-{tutorial-namespace} exec -it curler -- /bin/bash
----
...
kubectl -n %USER%-{tutorial-namespace} delete pod curler
...
[source,bash,subs="+macros,+attributes"]
----
kubectl -n %USER%-{tutorial-namespace} delete -f eventing-aloha-sink.yaml
kubectl -n %USER%-{tutorial-namespace} delete -f eventing-bonjour-sink.yaml
kubectl -n %USER%-{tutorial-namespace} delete -f trigger-helloaloha.yaml
kubectl -n %USER%-{tutorial-namespace} delete -f trigger-hellobonjour.yaml
kubectl -n %USER%-{tutorial-namespace} delete -f curler.yaml
kubectl -n %USER%-{tutorial-namespace} delete -f default-broker.yaml
----
--
====
