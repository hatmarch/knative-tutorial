...
[source,bash,subs="+macros,+attributes"]
----
kn source ping list -n %USER%-{tutorial-namespace}
----
...
eventinghello-ping-source   http://eventinghello.%USER%-{tutorial-namespace}.svc.cluster.local   47s   True
----
--
====
...
[source,bash,subs="+macros,+attributes"]
----
stern eventinghello -c user-container-n %USER%-{tutorial-namespace} 
----
...
[source,bash,subs="+macros,+attributes"]
----
kn source ping delete -n %USER%-{tutorial-namespace} eventinghello-ping-source 
kn service delete -n %USER%-{tutorial-namespace} eventinghello
----
--
{kubernetes-cli}::
+
...
[source,bash,subs="+macros,+attributes"]
----
{kubernetes-cli} -n %USER%-{tutorial-namespace} delete -f pass:[${TUTORIAL_HOME}]/eventing/eventinghello-source.yaml
{kubernetes-cli} -n %USER%-{tutorial-namespace} delete -f pass:[${TUTORIAL_HOME}]/eventing/eventing-hello-sink.yaml
----
--
====
