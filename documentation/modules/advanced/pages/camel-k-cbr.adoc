...
[source,bash,subs="+macros,+attributes"]
----
kubectl apply -n %USER%-{tutorial-namespace} -f $TUTORIAL_HOME/install/utils/fruityvice-proxy.yaml
----
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
kubectl apply -n %USER%-{tutorial-namespace} -f eip/fruits-processor.yaml
----
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
watch kubectl get  -n %USER%-{tutorial-namespace} camelsources
----
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
kubectl apply -n %USER%-{tutorial-namespace} \
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
kubectl apply -n %USER%-{tutorial-namespace} -f eip/sugary-fruits.yaml
----

Let us check the status of the Trigger using the command `kubectl -n %USER%-{tutorial-namespace} get triggers` which should return one trigger called `sugary-fruits` with ready state as shown below. 

[.console-input]
[#kamel-cbr-list-triggers]
[source,bash,subs="+quotes,+attributes,+macros"]
----
kubectl -n %USER%-{tutorial-namespace} get triggers
----
...
kubectl delete  -n %USER%-{tutorial-namespace} -f eip/fruits-processor.yaml
kubectl delete  -n %USER%-{tutorial-namespace} -f eip/sugary-fruits.yaml
kubectl delete -n %USER%-{tutorial-namespace} -f $TUTORIAL_HOME/install/utils/fruit-events-display.yaml
kubectl delete -n %USER%-{tutorial-namespace} -f $TUTORIAL_HOME/install/utils/fruityvice-proxy.yaml
