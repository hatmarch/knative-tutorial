...
[source,bash,subs="+quotes,+attributes,+macros"]
----
{kubernetes-cli} edit -n %USER%-{tutorial-namespace} cm camel-k-maven-settings
----
...
[source,bash,subs="+quotes,+attributes,+macros"]
----
oc edit  -n %USER%-{tutorial-namespace} cm camel-k-maven-settings
----
...
----
<1> This repository address needs to be updated as per your cluster setting. In example above the installed the Sonatype Nexus in the %USER%-{tutorial-namespace}.
