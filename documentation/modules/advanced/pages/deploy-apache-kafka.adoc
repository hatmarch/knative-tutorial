...
[source,bash,subs="+quotes,attributes+,+macros"]
----
{kubernetes-cli} create namespace kafka
----
...
/releases/download/{strimzi-version}/strimzi-cluster-operator-{strimzi-version}.yaml \
  ...
  | {kubernetes-cli} apply -n kafka -f -
----
...
[source,bash,subs="+quotes,attributes+,+macros"]
----
watch "{kubernetes-cli} get pods -n kafka"
----
...
[source,bash,subs="+quotes,attributes+,+macros"]
----
{kubernetes-cli} api-resources --api-group='kafka.strimzi.io'
----
...
[source,bash,subs="+quotes,attributes+,+macros"]
----
{kubernetes-cli} -n kafka apply -f kafka-broker-my-cluster.yaml
----
...
[source,bash,subs="+quotes,attributes+,+macros"]
----
{kubernetes-cli} -n kafka create -f kafka-topic-my-topic.yaml
----
...
[source,bash,subs="+quotes,attributes+,+macros"]
----
{kubernetes-cli} -n kafka  get kafkatopics
----
