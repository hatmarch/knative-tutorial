...
[source,bash,subs="+quotes,attributes+,+macros"]
----
kubectl get -n %USER%-{tutorial-namespace} channels
----
[.console-output]
[source,bash,subs="+quotes,attributes+,+macros"]
----
...
[source,bash,subs="+quotes,attributes+,+macros"]
----
kubectl get -n %USER%-{tutorial-namespace} kafkachannels
----
...
[source,bash,subs="attributes+,+macros",linenums]
----
kubectl -n %USER%-{tutorial-namespace} delete  channels.messaging.knative.dev my-events-ch
----
--
====
