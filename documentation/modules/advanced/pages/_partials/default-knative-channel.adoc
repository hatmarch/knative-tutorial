...
----
{kubernetes-cli} apply -f default-channel-config.yaml
----
...
[source,bash,subs="+quotes,attributes+,+macros"]
----
kn channel -n %USER%-{tutorial-namespace} ls
----
[.console-output]
[source,bash]
----
NAME           TYPE           URL                                                                AGE     READY   REASON
my-events-ch   KafkaChannel   http://my-events-ch-kn-channel.%USER%-{tutorial-namespace}.svc.cluster.local   2m55s   True
----
--
{kubernetes-cli}::
+
...
[source,bash,subs="+quotes,attributes+,+macros"]
----
{kubernetes-cli} get -n %USER%-{tutorial-namespace} channels
----
[.console-output]
[source,bash,subs="+quotes,attributes+,+macros"]
----
NAME           READY   URL                                                                
my-events-ch   True    http://my-events-ch-kn-channel.%USER%-{tutorial-namespace}.svc.cluster.local 
----
--
====
...
[source,bash,subs="+quotes,attributes+,+macros"]
----
{kubernetes-cli} get -n %USER%-{tutorial-namespace} kafkachannels
----
...
[source,bash,subs="+quotes,attributes+,+macros"]
----
{kubernetes-cli} get -n knative-eventing pods
----
...
----
kn channel delete -n %USER%-{tutorial-namespace} my-events-ch
----
--
{kubernetes-cli}::
+
...
[source,bash,subs="attributes+,+macros",linenums]
----
{kubernetes-cli} -n %USER%-{tutorial-namespace} delete  channels.messaging.knative.dev my-events-ch
----
--
====
