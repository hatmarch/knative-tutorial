...
[source,bash,subs="+macros,+attributes"]
----
kubectl --namespace %USER%-{tutorial-namespace} get routes.serving.knative.dev greeter
----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl --namespace %USER%-{tutorial-namespace} get builds.build.knative.dev event-greeter-build
----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl --namespace %USER%-{tutorial-namespace} get buildtemplates.build.knative.dev build-java-maven
----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl --namespace %USER%-{tutorial-namespace} get channels.eventing.knative.dev ch-event-greeter
----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl --namespace %USER%-{tutorial-namespace} get cronjobsources.sources.eventing.knative.dev  event-greeter-cronjob-source
----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl --namespace %USER%-{tutorial-namespace} get subscriptions.eventing.knative.dev event-greeter-subscriber
----
...
[source,bash,subs="+macros,+attributes"]
----
kubectl --namespace %USER%-{tutorial-namespace}  get services.serving.knative.dev event-greeter  
----
copyToClipboard::knative-services[]
--
oc::
